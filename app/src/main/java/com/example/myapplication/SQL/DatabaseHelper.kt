...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    private val CREATE_USER_TABLE = ("CREATE TABLE " + TABLE_USER + "("
            + COLUMN_USER_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_USER_NAME + " TEXT,"
             + COLUMN_USER_PASSWORD + " TEXT, " + COLUMN_USER_POINTS + " INTEGER"+")")
    ...
    fun getAllUser(): List<User> {
        ...
        val columns = arrayOf(COLUMN_USER_ID, COLUMN_USER_NAME, COLUMN_USER_PASSWORD, COLUMN_USER_POINTS)
     ...
     * @param user
     */
    fun updateUser(points: Int,userName: String) {
        val db = this.writableDatabase
        val values = ContentValues()
    ...
    fun  getUserPoints(userName: String):Int{
        ...
        val cursor = db.query(TABLE_USER, //Table to query
            columns,            //columns to return
            COLUMN_USER_NAME+" =  ?",     //columns for the WHERE clause
    ...
    companion object {
        ...
        private val COLUMN_USER_POINTS = "user_points"
    }
}